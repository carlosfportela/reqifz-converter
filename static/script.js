document.addEventListener('DOMContentLoaded', () => {
    ...
    function updateFileListUI() {
        ...
        currentFiles.forEach((file, index) => {
            ...
            li.innerHTML = `
                ...
                <button class="btn-icon" data-index="${index}" title="Remover"><i class="fa-solid fa-xmark"></i></button>
            `;
    ...
    function renderResults(data) {
        ...
        data.results.forEach(result => {
            ...
            logContent.textContent = result.logs || (result.status === 'success' ? 'Sucesso, nenhum log gerado.' : 'Falha sem logs.');
            ...
            if (result.status === 'success') {
                ...
                li.innerHTML = `
                    <div class="file-info">
                        ...
                        <div class="file-size" style="color:var(--danger-color)">Falha na conversão</div>
                    </div>
                `;
            }
